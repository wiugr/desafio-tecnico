...
deuses.forEach(deus => console.log(deus.name + ": " + deus.features.length));

const deusesMid = deuses.filter(deus => deus.roles.includes("Mid"));
console.log(deusesMid);

deuses.sort((a, b) => a.pantheon.localeCompare(b.pantheon));
console.log(deuses);

 const deusesESuasClasses = deuses.map(deus => deus.name+"("+deus.class+")")
 console.log(deusesESuasClasses)
